    ...
    return (
        <div className="flex flex-col h-[95vh] bg-gray-100 p-4 max-w-md mx-auto">
            ...
            <div className="flex gap-2 p-2 rounded-lg">
                ...
                />
                <button onClick={sendMessage} disabled={loading} className="bg-gray-700 ml-[-8px] text-white px-6 py-2 rounded-sm rounded-l-none transition-all hover:bg-slate-950 font-semibold">{loading ? "Thinking..." : "Send"}</button>
            </div>
        </div>
    );
}
